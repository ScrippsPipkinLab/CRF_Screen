...
########## Main ##########
#----- Directory
wk_dir = "/Volumes/Yolanda/CRF_Screen/InVivo/1_1_Norm/20190402_Exp35_rmOutlier_rawcountDistribution"
os.chdir(wk_dir)
...
def Q4minusQ1(q4File, q1File):
    #q4File = "/Volumes/Yolanda/CRF_Screen/InVivo/1_1_Norm/20190401/P1-7_Q4_flt_nbRawCount.csv"
    #q1File = "/Volumes/Yolanda/CRF_Screen/InVivo/1_1_Norm/20190401/P1-7_Q1_flt_nbRawCount.csv"
    ...
    del q1Tab['count']
    del q1Tab['type']
    q4Tab["nbRawCount"].name = "nbPctg_Q4"
    q1Tab["nbRawCount"].name = "nbPctg_Q1"
...
P17Q4 = "P1-7_Q4_combined_fltoutlier_nbRawCount.csv" 
P17Q1 = "P1-7_Q1_combined_fltoutlier_nbRawCount.csv" 
Q4minusQ1(P17Q4, P17Q1)

P814Q4 = "P8-14_Q4_combined_fltoutlier_nbRawCount.csv" 
P814Q1 = "P8-14_Q1_combined_fltoutlier_nbRawCount.csv" 
Q4minusQ1(P814Q4, P814Q1)

P1521Q4 = "P15-21_Q4_combined_fltoutlier_nbRawCount.csv" 
P1521Q1 = "P15-21_Q1_combined_fltoutlier_nbRawCount.csv" 
...
def Q3minusOther(q4File, q3File, q2File, q1File):
    ...
    del q1Tab['type']
    q4Tab["nbRawCount"].name = "nbPctg_Q4"
    q3Tab["nbRawCount"].name = "nbPctg_Q3"
    q2Tab["nbRawCount"].name = "nbPctg_Q2"
    q1Tab["nbRawCount"].name = "nbPctg_Q1"
...
P17Q4 = "P1-7_Q4_combined_fltoutlier_nbRawCount.csv" 
P17Q3 = "P1-7_Q3_combined_fltoutlier_nbRawCount.csv" 
P17Q2 = "P1-7_Q2_combined_fltoutlier_nbRawCount.csv" 
P17Q1 = "P1-7_Q1_combined_fltoutlier_nbRawCount.csv" 
Q3minusOther(P17Q4, P17Q3, P17Q2, P17Q1)

P814Q4 = "P8-14_Q4_combined_fltoutlier_nbRawCount.csv" 
P814Q3 = "P8-14_Q3_combined_fltoutlier_nbRawCount.csv" 
P814Q2 = "P8-14_Q2_combined_fltoutlier_nbRawCount.csv" 
P814Q1 = "P8-14_Q1_combined_fltoutlier_nbRawCount.csv" 
Q3minusOther(P814Q4, P814Q3, P814Q2, P814Q1)

P1521Q4 = "P15-21_Q4_combined_fltoutlier_nbRawCount.csv" 
P1521Q3 = "P15-21_Q3_combined_fltoutlier_nbRawCount.csv" 
P1521Q2 = "P15-21_Q2_combined_fltoutlier_nbRawCount.csv" 
P1521Q1 = "P15-21_Q1_combined_fltoutlier_nbRawCount.csv" 
...
def InputVsRest(q4File, q3File, q2File, q1File,inputFile):
    ...
    q2Tab["nbRawCount"].name = "nbPctg_Q2"
    q1Tab["nbRawCount"].name = "nbPctg_Q1"
    inputTab["nbRawCount"].name = "nbPctg_input"
    allTab = join(q4Tab, q3Tab, join_type="inner", keys="shRNA")
    allTab = join(allTab, q2Tab, join_type="inner", keys="shRNA")
    allTab = join(allTab, q1Tab, join_type="inner", keys="shRNA")
...
P17Q2 = "P1-7_Q2_combined_fltoutlier_nbRawCount.csv" 
P17Q1 = "P1-7_Q1_combined_fltoutlier_nbRawCount.csv" 
P17input = "P1-7_Input_combined_fltoutlier_nbRawCount.csv" 
...
P814Q2 = "P8-14_Q2_combined_fltoutlier_nbRawCount.csv" 
P814Q1 = "P8-14_Q1_combined_fltoutlier_nbRawCount.csv" 
P814input = "P8-14_Input_combined_fltoutlier_nbRawCount.csv" 
...
P1521Q2 = "P15-21_Q2_combined_fltoutlier_nbRawCount.csv" 
P1521Q1 = "P15-21_Q1_combined_fltoutlier_nbRawCount.csv" 
P1521input = "P15-21_Input_combined_fltoutlier_nbRawCount.csv" 
...
os.chdir("/Volumes/Yolanda/CRF_Screen/InVivo/1_1_Norm/20190402_Exp35_rmOutlier_rawcountDistribution/GateComparisons")
