...
########## Main ##########
#----- Directory
wk_dir = "/Volumes/Yolanda/CRF_Screen/InVivo/1_1_Norm/20190506_Exp35Exp56_cellN"
os.chdir(wk_dir)
...
#----- Adjust by cell number expansion
os.chdir("/Volumes/Yolanda/CRF_Screen/InVivo/1_1_Norm/20190506_Exp35Exp56_cellN/pctg")
for file in glob.glob("*Exp35Exp56_pctg.csv"):
    #file = "P1-7_Input_Exp35Exp56_pctg.csv"
    new_file = file.replace(".csv", "_cellNadj.csv")
    tab = ascii.read(file)
    pctg_list = tab['pctg']
    if "Input" in file:
        tab['adjPctg'] = pctg_list
    elif "Q1" in file:
        tab['adjPctg'] = [800*float(x) for x in pctg_list]
    elif "Q2" in file:
        tab['adjPctg'] = [80*float(x) for x in pctg_list]
    elif "Q3" in file:
        tab['adjPctg'] = [50*float(x) for x in pctg_list] 
    elif "Q4" in file:
        tab['adjPctg'] = [70*float(x) for x in pctg_list]  
    del tab['pctg']
    ascii.write(tab, new_file, format="csv", overwrite=True)

#----- Calculate percentiles of count percentage in total distribution

os.chdir("/Volumes/Yolanda/CRF_Screen/InVivo/1_1_Norm/20190506_Exp35Exp56_cellN/pctg_cellNadj")
pctgmillion_list = []
for file in glob.glob("*Exp35Exp56_pctg_cellNadj.csv"):
    tab = ascii.read(file)
    pctgmillion_list += [x*1000000 for x in list(tab["adjPctg"])]
...
###--- Gate comparisons
os.chdir("/Volumes/Yolanda/CRF_Screen/InVivo/1_1_Norm/20190506_Exp35Exp56_cellN/nbPctgTotal")
#----- Q1vQ4
...
P17Q4 = "P1-7_Q4_Exp35Exp56_pctg_cellNadj_nbPctgTotal.csv" 
P17Q1 = "P1-7_Q1_Exp35Exp56_pctg_cellNadj_nbPctgTotal.csv" 
Q4minusQ1(P17Q4, P17Q1)

P814Q4 = "P8-14_Q4_Exp35Exp56_pctg_cellNadj_nbPctgTotal.csv" 
P814Q1 = "P8-14_Q1_Exp35Exp56_pctg_cellNadj_nbPctgTotal.csv" 
Q4minusQ1(P814Q4, P814Q1)

P1521Q4 = "P15-21_Q4_Exp35Exp56_pctg_cellNadj_nbPctgTotal.csv" 
P1521Q1 = "P15-21_Q1_Exp35Exp56_pctg_cellNadj_nbPctgTotal.csv" 
...
P17Q4 = "P1-7_Q4_Exp35Exp56_pctg_cellNadj_nbPctgTotal.csv" 
P17Q3 = "P1-7_Q3_Exp35Exp56_pctg_cellNadj_nbPctgTotal.csv" 
P17Q2 = "P1-7_Q2_Exp35Exp56_pctg_cellNadj_nbPctgTotal.csv" 
P17Q1 = "P1-7_Q1_Exp35Exp56_pctg_cellNadj_nbPctgTotal.csv" 
Q3minusOther(P17Q4, P17Q3, P17Q2, P17Q1)

P814Q4 = "P8-14_Q4_Exp35Exp56_pctg_cellNadj_nbPctgTotal.csv" 
P814Q3 = "P8-14_Q3_Exp35Exp56_pctg_cellNadj_nbPctgTotal.csv" 
P814Q2 = "P8-14_Q2_Exp35Exp56_pctg_cellNadj_nbPctgTotal.csv" 
P814Q1 = "P8-14_Q1_Exp35Exp56_pctg_cellNadj_nbPctgTotal.csv" 
Q3minusOther(P814Q4, P814Q3, P814Q2, P814Q1)

P1521Q4 = "P15-21_Q4_Exp35Exp56_pctg_cellNadj_nbPctgTotal.csv" 
P1521Q3 = "P15-21_Q3_Exp35Exp56_pctg_cellNadj_nbPctgTotal.csv" 
P1521Q2 = "P15-21_Q2_Exp35Exp56_pctg_cellNadj_nbPctgTotal.csv" 
P1521Q1 = "P15-21_Q1_Exp35Exp56_pctg_cellNadj_nbPctgTotal.csv" 
...
P17Q2 = "P1-7_Q2_Exp35Exp56_pctg_cellNadj_nbPctgTotal.csv" 
P17Q1 = "P1-7_Q1_Exp35Exp56_pctg_cellNadj_nbPctgTotal.csv" 
P17input = "P1-7_Input_Exp35Exp56_pctg_cellNadj_nbPctgTotal.csv" 
...
P814Q2 = "P8-14_Q2_Exp35Exp56_pctg_cellNadj_nbPctgTotal.csv" 
P814Q1 = "P8-14_Q1_Exp35Exp56_pctg_cellNadj_nbPctgTotal.csv" 
P814input = "P8-14_Input_Exp35Exp56_pctg_cellNadj_nbPctgTotal.csv" 
...
P1521Q2 = "P15-21_Q2_Exp35Exp56_pctg_cellNadj_nbPctgTotal.csv" 
P1521Q1 = "P15-21_Q1_Exp35Exp56_pctg_cellNadj_nbPctgTotal.csv" 
P1521input = "P15-21_Input_Exp35Exp56_pctg_cellNadj_nbPctgTotal.csv" 
