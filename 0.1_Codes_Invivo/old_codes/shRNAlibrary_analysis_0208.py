...
def normInput(fileList):
    ...
    for idx, tab in enumerate(tabList):
        ...
        tabList[idx]['pctg'] = tab_counts_pctg
    # Z-Score
    newTab=Table()
...
wk_dir = "/Volumes/Yolanda/CRF_Screen/InVivo/1_1_Norm/20190208"
os.chdir(wk_dir)
...
ascii.write(whole_tab, "PctgZscore.csv", format="csv", overwrite=True)
