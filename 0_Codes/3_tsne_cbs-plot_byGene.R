...
#--- perplexity = 5
if (FALSE){
  wk.dir <- "/Users/yolandatiao/Desktop/CRF_Screen/2_0_t-test_by_gene/compiled_Amt/tsne_bbplot"
  setwd(wk.dir)
  
  tsne <- "/Users/yolandatiao/Desktop/CRF_Screen/2_0_t-test_by_gene/compiled_Amt/Amt_normbycontrolZP_t-test.by.geneavg_z-score_tsne.csv"
  z.score <- "/Users/yolandatiao/Desktop/CRF_Screen/2_0_t-test_by_gene/compiled_Amt/Amt_normbycontrolZP_t-test.by.geneavg_z-score.csv"
  p.value <- "/Users/yolandatiao/Desktop/CRF_Screen/2_0_t-test_by_gene/compiled_Amt/Amt_normbycontrolZP_t-test.by.genet-test_p-value.csv"
  
  colnames.vec <- c("CD103Percentage_100U", "CD103Percentage_10U", "CD127GeoMean_100U", 
                    "CD127GeoMean_10U", "CD25GeoMean_100U", "CD25GeoMean_10U", "CD44GeoMean_100U", 
                    "CD44GeoMean_10U", "CD62LPercentage_100U", "CD62LPercentage_10U", "CXCR3GeoMean_100U", 
                    "CXCR3GeoMean_10U", "CXCR3Percentage_100U", "CXCR3Percentage_10U", "Lag3GeoMean_100U",
                    "Lag3GeoMean_10U", "PD1GeoMean_100U", "PD1GeoMean_10U", "Tim3GeoMean_100U", "Tim3GeoMean_10U", 
...
#--- perplexity = 10
if (FALSE){
  wk.dir <- "/Users/yolandatiao/Desktop/CRF_Screen/2_0_t-test_by_gene/compiled_Amt/tsne-per10_cbs-plot"
  setwd(wk.dir)
  
  tsne <- "/Users/yolandatiao/Desktop/CRF_Screen/2_0_t-test_by_gene/compiled_Amt/Amt_normbycontrolZP_t-test.by.geneavg_z-score_tsne_per10.csv"
  z.score <- "/Users/yolandatiao/Desktop/CRF_Screen/2_0_t-test_by_gene/compiled_Amt/Amt_normbycontrolZP_t-test.by.geneavg_z-score.csv"
  p.value <- "/Users/yolandatiao/Desktop/CRF_Screen/2_0_t-test_by_gene/compiled_Amt/Amt_normbycontrolZP_t-test.by.genet-test_p-value.csv"
