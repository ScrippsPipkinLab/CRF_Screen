...
#--- Read tpm file
zscore_file = "Amt_normbycontrolZP_t-test.by.geneavg_z-score.csv"
zscore_df = ascii.read(zscore_file)
zscore_names = zscore_df.colnames
gene_names = list(zscore_df["gene_name"])
...
def tsne_conversion(zscore_arr, per_n): 
    ...
    out_name = "Amt_normbycontrolZP_t-test.by.geneavg_z-score_tsne_per%s.csv"%per_n
